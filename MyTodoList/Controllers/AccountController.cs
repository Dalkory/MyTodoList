...
using MyTodoList.Domain;
using MyTodoList.Domain.Entities;
using MyTodoList.Models.Account;
using System.Security.Claims;


namespace MyTodoList.Controllers
{
    public class AccountController : MyTodoBaseController
    {
        private MyTodoListContext _context;
        public AccountController(MyTodoListContext context)
        {
            _context = context;
        }
        ...
        private async Task AuthenticateAsync(User user)
        {
            ...
            var id = new ClaimsIdentity(claims, "ApplocationCookie", ClaimsIdentity.DefaultNameClaimType, ClaimsIdentity.DefaultRoleClaimType);
